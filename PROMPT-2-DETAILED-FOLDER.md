...
---
# INDICADOR 2: Analizar la carpeta de documentos
...
1. **Copie todo el mensaje anterior**
2. **Reemplazar ruta de la carpeta**:
...
Pruebe con:
- `/help/delivery/using/` (111 archivos)
- `/help/workflow/using/` (121 archivos)
...
El informe tendrá entre 30 y 40 páginas de Markdown detallado con:
- Estadísticas de resumen
- Completar tabla con todos los archivos
- Hasta 3 coincidencias de v8 por archivo
- Coincidir porcentajes
