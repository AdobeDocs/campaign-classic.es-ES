...
1. En Adobe Campaign Explorer, seleccione el nodo **[!UICONTROL Administration > Configuration > Data schemas]**.
...
1. En Adobe Campaign Explorer, seleccione el nodo **[!UICONTROL Administration > Configuration > JavaScript Templates]**.
