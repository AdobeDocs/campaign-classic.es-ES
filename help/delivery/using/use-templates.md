...
**Sugerencia**: Para evitar errores de configuración en Campaign Standard, se recomienda duplicar una plantilla nativa y modificar sus propiedades en lugar de crear una nueva plantilla.
