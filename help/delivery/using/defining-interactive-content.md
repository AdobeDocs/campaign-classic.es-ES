...
>[!IMPORTANT]
>
>* Esta función es una capacidad beta de Adobe Campaign.
>* AMP para correo electrónico es un nuevo formato de origen abierto que permite a los desarrolladores crear correos electrónicos dinámicos e interactivos. Actualmente, cuenta con el apoyo de algunos proveedores de correo electrónico: Gmail, Outlook y Mail.ru.


Por ahora, únicamente puede:
...
El siguiente vídeo explica cómo activar AMP en Adobe Campaign Classic y muestra el uso.
...
1. Instale el paquete **[!UICONTROL AMP support (Beta)]**. Consulte [Instalación de paquetes estándar de Campaign](../../installation/using/installing-campaign-standard-packages.md).
...
1. Asegúrese de seguir todos los requisitos de entrega de los proveedores de correo electrónico que admiten el formato AMP. Consulte [requisitos de AMP para entrega por correo electrónico](#amp-for-email-delivery-requirements).
   ...
   >[!NOTE]
   >
   >AMP para correo electrónico está disponible como una capacidad beta para fines de prueba. Actualmente, solo unos pocos proveedores de correo electrónico admiten la prueba de este formato.
...
1. Al definir el objetivo, asegúrese de seleccionar los destinatarios que podrán visualizar el formato AMP. Consulte [Objetivización de un correo electrónico AMP](#targeting-amp-email).
   ...
   >[!NOTE]
   >
   >Actualmente solo puede probar la entrega de correos electrónicos AMP a direcciones de correo electrónico específicas correctamente configuradas o después de registrarse con los proveedores de correo electrónico que participan en el programa beta AMP.
...
AMP para correo electrónico, disponible como capacidad beta, actualmente puede experimentar la entrega de un correo electrónico AMP en dos pasos:
...
1. Una vez probada, puede enviar un envío o una campaña como parte del programa de AMP para la versión beta de correo electrónico registrándose con los proveedores de correo electrónico relevantes para que se agregue su dominio remitente a la lista de permitidos. Consulte [Envío de correos electrónicos AMP mediante registro en un proveedor de correo electrónico](#delivering-amp-emails-by-registering).
...
Para Gmail y Outlook, primero debe agregar las direcciones de remitente que está utilizando a la lista de permitidos para enviarlas desde Adobe Campaign a las cuentas de Gmail y Outlook que está utilizando.
...
Puede experimentar la entrega de correos electrónicos dinámicos registrándose con los proveedores de correo electrónico que participan en el programa beta de AMP para que se agregue su dominio remitente a la lista de permitidos.
