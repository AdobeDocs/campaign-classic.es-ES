...
seo-title: Acerca del canal de correo postal
...
Las secciones a continuación proporcionan información específica para el canal de correo directo. Para obtener información global sobre cómo crear y enviar una entrega, consulte[esta sección](../../delivery/using/steps-about-delivery-creation-steps.md).
