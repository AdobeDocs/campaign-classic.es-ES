...
>[!NOTE]
>
>Esta opción se utiliza cuando la tabla de destinatario empleada no es la tabla predeterminada **nms:recipient** y está utilizando la funcionalidad Presentación de la bandeja de entrada suministrada con el módulo **[!UICONTROL Deliverability]** de Adobe Campaign.
>
