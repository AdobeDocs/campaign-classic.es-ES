...
Además, los envíos de tipo “Otros” utilizan una plantilla técnica específica que no ejecuta un proceso: esto les permite administrar las acciones de marketing ejecutadas fuera de la plataforma de Adobe Campaign.
...
Este canal está diseñado únicamente con fines descriptivos. Por ejemplo, para definir los envíos para los que desea mantener un seguimiento del objetivo de una campaña realizada en una herramienta distinta de Adobe Campaign.
