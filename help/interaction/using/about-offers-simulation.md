...
1. Vaya a la pestaña **[!UICONTROL Editar]** y especifique la configuración de ejecución.
...
1. Añada ejes al sistema de informes para mejorar el informe **[!UICONTROL Distribuir ofertas por rango]** (opcional).
...
1. Haga clic en **[!UICONTROL Guardar]** para guardar los ajustes de la simulación.
