...
Como usuario alojado, se beneficia automáticamente de la actualización anual de Campaign con la última versión estable sin tener que realizar ninguna acción. Los clientes on-premise e híbridos también pueden beneficiarse de esta versión. Si migra desde una compilación antigua, le recomendamos que la actualice primero a esta versión. [Más información](../../rn/using/rn-overview.md).
...
El seguimiento de vínculos en correos electrónicos que ya se han enviado no funcionará durante la actualización porque se detienen todos los servidores. Volverán a estar operativos una vez finalizada la actualización y se reinicien los servidores.
...
## Generación de una lista de comprobación de actualizaciones {#check-list}
...
* [Programa de actualización anual](../../rn/using/rn-overview.md#yearly-upgrade)
