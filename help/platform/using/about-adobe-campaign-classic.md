...
Para obtener más información sobre las funcionalidades Adobe Campaign y cómo empezar a utilizarlo, consulte la [documentación de Campaign v8](https://experienceleague.adobe.com/es/docs/campaign/campaign-v8/new/get-started){target=_blank}.
...
* Obtenga información sobre cómo instalar e iniciar sesión en Adobe Campaign [en esta página](launching-adobe-campaign.md).

>[!TAB Exploración de la interfaz de usuario de Campaign]

* Descubra la interfaz de usuario de Adobe Campaign [en esta página](adobe-campaign-workspace.md).

* Aprenda a trabajar con [Campaign Explorer](adobe-campaign-workspace.md#using-adobe-campaign-explorer).
...
>[!VIDEO](https://video.tv.adobe.com/v/39516?captions=spa&quality=12)
