...
Tómese el tiempo necesario para ver la [Lista de control de seguridad y privacidad](../../installation/using/get-started-security-privacy.md) y conocer los elementos clave que debe comprobar en materia de seguridad y privacidad.

>[!NOTE]
>
>Para obtener más información sobre las normas de privacidad y seguridad, consulte la [documentación de l versión 8 de Campaign](https://experienceleague.adobe.com/es/docs/campaign/campaign-v8/privacy/security){target=_blank}.
