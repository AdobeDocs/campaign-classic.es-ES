...
¿Necesita ayuda para trabajar con Campaign Classic? Lea las 10 preguntas más frecuentes a continuación y otras preguntas frecuentes de esa página. También puede [ver vídeos de introducción](https://docs.adobe.com/content/help/en/campaign-learn/campaign-classic-tutorials/overview.html) y leer [las guías de introducción de Campaign](../../platform/using/tutorials.md#step-by-step-guides) para aprender a utilizar los conceptos clave. ¿No encuentra la respuesta? [Pregunte a la comunidad](https://forums.adobe.com/community/experience-cloud/marketing-cloud/campaign).
...
[Lea este artículo](https://helpx.adobe.com/es/campaign/kb/acc-build-upgrade.html) para aprender a actualizar su entorno y leer [las preguntas comunes](https://helpx.adobe.com/es/campaign/kb/build-upgrade-faq.html) sobre este tema específico.
...
Puede obtener la lista de todos los sistemas y componentes compatibles con la última versión de Campaign en [Adobe Campaign Compatibility matrix](https://helpx.adobe.com/es/campaign/kb/compatibility-matrix.html).

## 8. ¿Dónde se encuentran las notas de la versión de Campaign Classic? {#where-are-campaign-classic-release-notes-}

Puede acceder a las notas más recientes de la versión Campaign Classic [en esta página](https://docs.adobe.com/content/help/es-ES/campaign-classic/using/release-notes/latest-release.html).

## 9. ¿Cuál es el procedimiento para la delegación de dominios? {#what-is-the-procedure-for-domain-delegation-}
