...
Puede realizar un seguimiento de los envíos realizados con Campaign Classic a través de los [ informes de envío](../../reporting/using/delivery-reports.md) específicos y luego monitorizarlos.
