...
Descubra cómo implementar la aprobación del contenido de su envío en la [documentación de la versión 8 de Campaign](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=es#review-and-approve-deliveries){target="_blank"}.
