...
#### Actualización de lista de permitidos de URL externas {#security-enhancement-url-validation-9401}
...
Esta versión incluye varias mejoras de productos, correcciones de seguridad y la actualización a la API de Adobe Analytics 2.0 para el conector de Adobe Analytics.
...
#### Actualización de Adobe Analytics 2.0 {#analytics-2-0-7-4-4}

Las API de Adobe Analytics 1.4 se acercan al final de su vida útil. Si utiliza el conector de Adobe Analytics, debe actualizar a esta versión y completar algunos pasos de migración según su implementación y caso de uso. [Descubra cómo se migra a la API de Adobe Analytics 2.0](../../technotes/using/analytics-2-migration.md).
...
Se requiere un [reinicio del servidor de Adobe Campaign (nlserver)](../../production/using/usual-commands.md#restart-services) para cargar la compilación y completar la implementación. La corrección se activa de forma predeterminada una vez reiniciado el sistema.
...
Esta compilación incluye correcciones de seguridad y reemplaza a las compilaciones anteriores de Campaign Classic v7. Esta compilación ya no se utiliza en las implementaciones locales e híbridas. Recomendamos a los clientes que usen estos modos de implementación que instalen las actualizaciones lo antes posible mediante la actualización a la [Compilación 9398](#build-9398) o posterior.
