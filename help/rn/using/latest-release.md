...
## ![](assets/do-not-localize/blue_2.png) Versión 20.3.3: compilación 9234 {#release-20-3-3-build-9234}
...
> * Si está utilizando la integración de Experience Cloud Triggers mediante oAuth authentication, debe desplazarse a Adobe I/O como se describe [en esta página](../../integrations/using/configuring-adobe-io.md). El modo oAuth authentication heredado se eliminará el **30 de abril de 2021**.
