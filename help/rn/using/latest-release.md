...
Adobe Campaign ahora es compatible con Windows Server 2019. Consulte la [Matriz de compatibilidad de Campaign](../../rn/using/compatibility-matrix.md#OperatingSystems).
