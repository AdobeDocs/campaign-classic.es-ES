...
<tr>
 ...
 <td><p>El marketing social con Facebook ya no se utiliza. Puede usar la integración de X (anteriormente conocido como Twitter) para publicar en medios sociales o trabajar con Adobe para crear un canal personalizado.</p>
  <!--p>Target removal date: End of 2023</p-->
  </td>
</tr>
<tr>
 <td>Conector ACS</td>
 <td><p>El conector ACS (oferta Prime) ya no se utiliza. Puede utilizar las funcionalidades de exportación e importación de Campaign para extraer e insertar datos en ambos productos.</p>
  <!--p>Target removal date: End of 2023</p-->
  </td>
</tr>
 </tbody> 
...
<table> 
 <tbody>
  ...
  <td>Conector de datos de Adobe Analytics<br></td>
   ...
   <p>Si utiliza este conector, debe adaptar la implementación en consecuencia. <a href="../../integrations/using/gs-aa.md">Más información</a></p>
  </td>
 </tr>
    <tr>
  ...
  <p>Si utilizaba la integración de activadores, aprenda a adaptar la implementación <a href="../../integrations/using/about-triggers.md#implement">en esta página</a>.</p> 
  ...
  <td><p> A partir de la versión 21.1.3 de Campaign, el dominio de demdex utilizado para importar y exportar públicos a Adobe Experience Cloud ya no está disponible. <a href="../../integrations/using/configuring-shared-audiences-integration-in-adobe-campaign.md">Más información</a></p> 
   ...
   <td>A partir de la versión 19.1 de Campaign, las API de Campaign Classic están disponibles en una página dedicada. Si utilizó el archivo jsapi.chm heredado, debería consultar la <a href="https://experienceleague.adobe.com/es/tools/campaign-api">nueva versión en línea</a>.</td>
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <p>En el contexto de una actualización posterior a la versión 18.6 (y versiones posteriores), esta API ya no se activa y se ha sustituido por la función <em>decryptPassword. </em> <a href="https://experienceleague.adobe.com/es/tools/campaign-api">Más información</a></p></td>
  </tr> 
   <tr> 
...
* A partir de la versión 7.3.4, Adobe Campaign deja de ser compatible con Red Hat Enterprise Linux (RHEL) 7.

* A partir de la versión 7.3.1, Adobe Campaign deja de ser compatible con Windows 8 y Windows Server 2012.
