...
El **[!UICONTROL Owner of domain]** campo permite agrupar varios nombres de dominio bajo la misma etiqueta. En la vista del informe inicial, todos los nombres de dominio MX se asociarán a este propietario.
