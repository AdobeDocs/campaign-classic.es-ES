...
Ir a **[!UICONTROL Monitoring]** y haga clic en **[!UICONTROL Overview]** para mostrar la página de monitorización de procesos de Adobe Campaign.
...
Es posible mostrar el diario de registro relacionado con un proceso. Para ello, haga clic en el proceso, **mta** por ejemplo, luego haga clic en **[!UICONTROL Open the log journal]** .
...
Adobe Campaign permite personalizar los indicadores. Para ello, haga lo siguiente:
