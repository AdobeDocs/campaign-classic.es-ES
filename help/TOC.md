...
+ Introducción {#getting-started}
   ...
   + [Creación de consultas en Campaign](platform/using/adobe-campaign-workspace.md#about-queries-in-campaign)
...
+ Creación y envío de mensajes  {#sending-messages}
   ...
   + [Configuración del envío: OCULTO](delivery/using/delivery-settings.md)
   + Inicio rápido {#key-steps-when-creating-a-delivery}
      + [Introducción a los envíos: OCULTO](delivery/using/steps-about-delivery-creation-steps.md)
      + [Crear e identificar un envío: OCULTO](delivery/using/steps-create-and-identify-the-delivery.md)
      + [Definición del público: OCULTO](delivery/using/steps-defining-the-target-population.md)
      + [Validar el envío: OCULTO](delivery/using/steps-validating-the-delivery.md)
      + [Realizar el envío: OCULTO](delivery/using/steps-sending-the-delivery.md)
      + [Prácticas recomendadas para envíos: OCULTO](delivery/using/delivery-best-practices.md)
   + Prácticas recomendadas para envíos {#delivery-bestpractices}
      + [Optimizar el envío: OCULTO](delivery/using/optimize-delivery.md)
      + [Uso de plantillas: OCULTO](delivery/using/use-templates.md)
      + [Generar contenido personalizado: OCULTO](delivery/using/design-and-personalize.md)
      + [Definición del público correcto: OCULTO](delivery/using/define-the-right-audience.md)
      + [Comprobar antes de enviar: OCULTO](delivery/using/check-before-sending.md)
   + [Envío de correos electrónicos](delivery/using/about-email-channel.md)
   + Envío de correos electrónicos {#sending-emails}
      + [Crear un envío de correo electrónico: OCULTO](delivery/using/creating-an-email-delivery.md)
      ...
      + Envío de la entrega de correo electrónico {#sending-an-email}
         ...
         + [Parámetros de correo electrónico: OCULTO](delivery/using/email-parameters.md)
   ...
   + Uso de plantillas de envío {#using-delivery-templates}
      ...
      + [Crear una plantilla de envíos: OCULTO](delivery/using/creating-a-delivery-template.md)
      + [Seleccionar una asignación de destinatario: OCULTO](delivery/using/selecting-a-target-mapping.md)
      + [Crear un envío desde una plantilla: OCULTO](delivery/using/creating-a-delivery-from-a-template.md)
   + Personalizar los envíos  {#personalizing-deliveries}
      + [Acerca de la personalización](delivery/using/about-personalization.md)
      + [Campos de personalización: OCULTO](delivery/using/personalization-fields.md)
      + [Bloques personalizados: OCULTO](delivery/using/personalization-blocks.md)
      + [Contenido condicional: OCULTO](delivery/using/conditional-content.md)
      + [Cupones personalizados: OCULTO](delivery/using/personalized-coupons.md)
      + [Generar documentos PDF personalizados: OCULTO](delivery/using/generating-personalized-pdf-documents.md)
   ...
   + Monitorización de los envíos {#monitoring-deliveries}
      + [Monitorización del rendimiento de entrega](delivery/using/about-delivery-monitoring.md)
      + [Seguimiento de mensajes](delivery/using/about-message-tracking.md)
      + [Rendimiento de entrega y solución de problemas](delivery/using/delivery-performance-troubleshooting.md)
      + [Errores de envío y administración de cuarentena](delivery/using/delivery-failures-quarantine.md)
      + [Avanzado: personalizar registros de envío](delivery/using/customize-delivery-logs.md)
...
+ Orquestación de campañas de marketing {#orchestrating-campaigns}
   ...
   + Acerca de las campañas de marketing {#about-marketing-campaigns}
      ...
      + [Acceder a campañas de marketing: OCULTO](campaign/using/accessing-marketing-campaigns.md)
   + Organización de campañas {#orchestrate-campaigns}
      ...
      + [Crear y configurar plantillas: OCULTO](campaign/using/marketing-campaign-templates.md)
      + [Añadir envíos: OCULTO](campaign/using/marketing-campaign-deliveries.md)
      + [Seleccionar el público: OCULTO](campaign/using/marketing-campaign-target.md)
      + [Administrar documentos y recursos: OCULTO](campaign/using/marketing-campaign-assets.md)
      + [Configurar y administrar aprobaciones: OCULTO](campaign/using/marketing-campaign-approval.md)
      + [Monitorizar las campañas: OCULTO](campaign/using/marketing-campaign-monitoring.md)
      + [Proveedores, stocks y presupuestos: OCULTO](campaign/using/providers-stocks-and-budgets.md)
   + Optimización de la campaña {#campaign-optimization}
      ...
      + [Reglas de presión: OCULTO](campaign-opt/using/pressure-rules.md)
      + [Reglas de coherencia: OCULTO](campaign-opt/using/consistency-rules.md)
      + [Reglas de control: OCULTO](campaign-opt/using/control-rules.md)
      + [Opciones de filtrado: OCULTO](campaign-opt/using/filtering-rules.md)
      + [Aplicar reglas: OCULTO](campaign-opt/using/applying-rules.md)
      + [Simulaciones de campañas: OCULTO](campaign-opt/using/campaign-simulations.md)
+ Administración de recursos de marketing {#mrm}
   ...
   + [Creación y administración de tareas: OCULTO](mrm/using/creating-and-managing-tasks.md)
   + [Costes de control: OCULTO](mrm/using/controlling-costs.md)
   + [Administrar recursos de marketing: OCULTO](mrm/using/managing-marketing-resources.md)
...
+ Marketing distribuido {#distributed-marketing}
   ...
   + [Crear una campaña local: OCULTO](distributed/using/creating-a-local-campaign.md)
   + [Crear una campaña colaborativa: OCULTO](distributed/using/creating-a-collaborative-campaign.md)
   + [Publicar el paquete de campaña: OCULTO](distributed/using/publishing-the-campaign-package.md)
   + [Acceder a campañas: OCULTO](distributed/using/accessing-campaigns.md)
...
+ Automatización con flujos de trabajo {#automating-with-workflows}
   + Introducción a los flujos de trabajo {#introduction}
      + [Acerca de las actividades: OCULTO](workflow/using/about-activities.md)
      + [Crear un flujo de trabajo: OCULTO](workflow/using/building-a-workflow.md)
      + [Datos de destinatario: OCULTO](workflow/using/targeting-data.md)
      + [Uso de datos de flujo de trabajo: OCULTO](workflow/using/how-to-use-workflow-data.md)
      + [Prácticas recomendadas de flujos de trabajo: OCULTO](workflow/using/workflow-best-practices.md)
   + Ejecución de un flujo de trabajo {#executing-a-workflow}
      ...
      + [Definir aprobaciones: OCULTO](workflow/using/defining-approvals.md)
      + [Arquitectura: OCULTO](workflow/using/architecture.md)
   + Actividades de segmentación {#targeting-activities}
      ...
      + [Consulta incremental: OCULTO](workflow/using/incremental-query.md)
      + [Leer lista: OCULTO](workflow/using/read-list.md)
      + [Unión: OCULTO](workflow/using/union.md)
      + [Intersección: OCULTO](workflow/using/intersection.md)
      + [Exclusión: OCULTO](workflow/using/exclusion.md)
      + [División: OCULTO](workflow/using/split.md)
      + [Celdas: OCULTO](workflow/using/cells.md)
      + [Ofertas por celda: OCULTO](workflow/using/offers-by-cell.md)
      + [Descripción del envío: OCULTO](workflow/using/delivery-outline.md)
      + [Enriquecimiento: OCULTO](workflow/using/enrichment.md)
      + [Edición del esquema: OCULTO](workflow/using/edit-schema.md)
      ...
      + [Actualización de la lista: OCULTO](workflow/using/list-update.md)
   ...
   + Actividades de control de flujo {#flow-control-activities}
      ...
      + [Inicio y finalización: OCULTO](workflow/using/start-and-end.md)
      + [Bifurcación: OCULTO](workflow/using/fork.md)
      + [Combinación-Y: OCULTO](workflow/using/and-join.md)
      + [Planificador: OCULTO](workflow/using/scheduler.md)
      + [Prueba: OCULTO](workflow/using/test.md)
      + [Esperar: OCULTO](workflow/using/wait.md)
      + [Restricción de tiempo: OCULTO](workflow/using/time-constraint.md)
      + [Subflujo de trabajo: OCULTO](workflow/using/sub-workflow.md)
      + [Saltar (punto inicial y punto final: OCULTO)](workflow/using/jump-start-point-and-end-point.md)
      + [Señal externa: OCULTO](workflow/using/external-signal.md)
      + [Aprobación: OCULTO](workflow/using/approval.md)
      + [Alerta: OCULTO](workflow/using/alert.md)
      + [Tarea: OCULTO](workflow/using/task.md)
   + Actividades de acción {#action-activities}
      ...
      + [Envíos en canales múltiples: OCULTO](workflow/using/cross-channel-deliveries.md)
      + [Aprobación local: OCULTO](workflow/using/local-approval.md)
      + [Carga de datos (RDBMS): OCULTO](workflow/using/data-loading-rdbms.md)
      + [Carga (SOAP): OCULTO](workflow/using/loading-soap.md)
      ...
      + [Gestión de datos SQL: OCULTO](workflow/using/sql-data-management.md)
   ...
   + Actividades de evento {#event-activities}
      ...
      + [Recolector de ficheros: OCULTO](workflow/using/file-collector.md)
      + [Transferencia de archivos: OCULTO](workflow/using/file-transfer.md)
      + [Descarga de web: OCULTO](workflow/using/web-download.md)
      + [Correos electrónicos de entrada: OCULTO](workflow/using/inbound-emails.md)
      + [Código SMS de entrada: OCULTO](workflow/using/inbound-sms.md)
   + Casos de uso {#use-cases}
      + [Acerca de los casos de uso de flujos de trabajo: OCULTO](workflow/using/about-workflow-use-cases.md)
      + Envíos {#deliveries}
         + [Uso de la actividad de aprobación local: OCULTO](workflow/using/using-the-local-approval-activity.md)
         + [Enviar un correo electrónico de cumpleaños: OCULTO](workflow/using/sending-a-birthday-email.md)
         + [Carga de contenido de envíos: OCULTO](workflow/using/loading-delivery-content.md)
         + [Flujo de trabajo de envío en canales múltiples: OCULTO](workflow/using/cross-channel-delivery-workflow.md)
   ...
   + Monitorización {#monitoring}
      + [Enviar un informe a una lista: OCULTO](workflow/using/sending-a-report-to-a-list.md)
      + [Supervisar los flujos de trabajo: OCULTO](workflow/using/supervising-workflows.md)
      + [Enviar alertas personalizadas a operadores: OCULTO](workflow/using/sending-personalized-alerts-to-operators.md)
   + Administración de datos {#data-management}
      + [Coordinar actualizaciones de datos: OCULTO](workflow/using/coordinating-data-updates.md)
      ...
      + [Uso de acumulados: OCULTO](workflow/using/using-aggregates.md)
      + [Uso de la funcionalidad de combinación de la actividad de deduplicación: OCULTO](workflow/using/deduplication-merge.md)
      + [Configurar un flujo de trabajo de importación recurrente: OCULTO](workflow/using/recurring-import-workflow.md)
   ...
   + Consulta y filtro {#query-and-filter-hidden}
      ...
      + [Consulta de la información de envío: OCULTO](workflow/using/querying-delivery-information.md)
      + [Realizar cálculo de acumulados: OCULTO](workflow/using/performing-aggregate-computing.md)
      + [Consulta mediante la administración de agrupaciones: OCULTO](workflow/using/querying-using-grouping-management.md)
      + [Consulta con una relación de varios a varios: OCULTO](workflow/using/querying-using-many-to-many-relationship.md)
      + [Añadir un campo calculado de tipo lista desglosada: OCULTO](workflow/using/adding-enumeration-type-calculated-field.md)
      + [Crear un filtro: OCULTO](workflow/using/creating-a-filter.md)
      + [Filtro de destinatarios duplicados: OCULTO](workflow/using/filtering-duplicated-recipients.md)
   + Monitorización de flujos de trabajo {#monitoring-workflows}
      + [Monitorizar la ejecución del flujo de trabajo: OCULTO](workflow/using/monitoring-workflow-execution.md)
      + [Monitorizar flujos de trabajo técnicos: OCULTO](workflow/using/monitoring-technical-workflows.md)
      + [Mapa de calor del flujo de trabajo: OCULTO](workflow/using/heatmap.md)
   + Gestión avanzada {#advanced-management}
      + [Propiedades del flujo de trabajo: OCULTO](workflow/using/workflow-properties.md)
      + [Parámetros avanzados: OCULTO](workflow/using/advanced-parameters.md)
      + [Scripts y plantillas de JavaScript: OCULTO](workflow/using/javascript-scripts-and-templates.md)
      + [Ejemplos de código JavaScript en flujos de trabajo: OCULTO](workflow/using/javascript-in-workflows.md)
      + [Acceder a una base de datos externa: OCULTO](workflow/using/accessing-an-external-database-fda.md)
      + [Administración de permisos: OCULTO](workflow/using/managing-rights.md)
      + [Cambiar imágenes de actividad: OCULTO](workflow/using/managing-activity-images.md)
      + [Administrar zonas horarias: OCULTO](workflow/using/managing-time-zones.md)
      + [Flujos de trabajo técnicos: OCULTO](workflow/using/about-technical-workflows.md)
