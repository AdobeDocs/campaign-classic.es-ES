...
+ Notas técnicas {#technotes}
   ...
   + Actualizaciones y migraciones{#technote-migration}
...
+ [Panel de control de Campaign](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html)