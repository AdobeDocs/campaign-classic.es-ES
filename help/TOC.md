...
+ Notas de la versión  {#release-notes}
   ...
   + {hide-from-toc}[Actualizaciones de documentación: OCULTAS](rn/using/documentation-updates.md)
+ Introducción {#getting-started}
   ...
   + {hide-from-toc}[Usar el explorador de Campaign - OCULTO](platform/using/adobe-campaign-explorer.md)
   + {hide-from-toc}[Examinar y personalizar listas: OCULTAS](platform/using/adobe-campaign-ui-lists.md)
   + {hide-from-toc}[Enumeraciones - OCULTAS](platform/using/managing-enumerations.md)
   ...
   + Administración de perfiles {#profile-management}
      ...
      + {hide-from-toc}[Editar un perfil: OCULTO](platform/using/editing-a-profile.md)
      + {hide-from-toc}[Agregar perfiles - OCULTOS](platform/using/adding-profiles.md)
      + {hide-from-toc}[Administrar perfiles - OCULTOS](platform/using/managing-profiles.md)
   ...
   + Filtrado de datos {#filtering-data}
      + {hide-from-toc}[Opciones de filtrado - OCULTAS](platform/using/filtering-options.md)
      + {hide-from-toc}[Crear filtros - OCULTOS](platform/using/creating-filters.md)
      + {hide-from-toc}[Caso de uso: oculto](platform/using/use-case.md)
   + {hide-from-toc}[Pasos para crear una consulta - OCULTA](platform/using/steps-to-create-a-query.md)
   + {hide-from-toc}[Definir condiciones de filtro - OCULTO](platform/using/defining-filter-conditions.md)
   + Permisos {#permissions}
      ...
      + {hide-from-toc}[Administrar el acceso a las carpetas - OCULTO](platform/using/access-management-folders.md)
   + Conectores CRM {#connectors}
      + [Introducción a los conectores CRM](platform/using/crm-connectors.md)
      + {hide-from-toc}[Conectar con Microsoft Dynamics 365](platform/using/crm-ms-dynamics.md)
...
+ Creación y envío de mensajes  {#sending-messages}
   ...
   + Inicio rápido {#key-steps-when-creating-a-delivery}
      + {hide-from-toc}[Introducción a envíos: OCULTO](delivery/using/steps-about-delivery-creation-steps.md)
      + {hide-from-toc}[Crear e identificar un envío: OCULTO](delivery/using/steps-create-and-identify-the-delivery.md)
      + {hide-from-toc}[Definir la audiencia - OCULTA](delivery/using/steps-defining-the-target-population.md)
      + {hide-from-toc}[Validar la entrega - OCULTO](delivery/using/steps-validating-the-delivery.md)
      + {hide-from-toc}[Enviar la entrega - OCULTO](delivery/using/steps-sending-the-delivery.md)
      + {hide-from-toc}[Prácticas recomendadas de entrega: OCULTO](delivery/using/delivery-best-practices.md)
   + Prácticas recomendadas para envíos {#delivery-bestpractices}
      + {hide-from-toc}[Optimizar envío - OCULTO](delivery/using/optimize-delivery.md)
      + {hide-from-toc}[Usar plantillas - OCULTAS](delivery/using/use-templates.md)
      + {hide-from-toc}[Generar contenido personalizado - OCULTO](delivery/using/design-and-personalize.md)
      + {hide-from-toc}[Definir la audiencia correcta - OCULTA](delivery/using/define-the-right-audience.md)
   ...
   + Envío de correos electrónicos {#sending-emails}
      ...
      + {hide-from-toc}[Definir el contenido del correo electrónico - OCULTO](delivery/using/defining-the-email-content.md)
      + {hide-from-toc}[Definir contenido interactivo - OCULTO](delivery/using/defining-interactive-content.md)
   ...
   + Uso de plantillas de envíos {#using-delivery-templates}
      + {hide-from-toc}[Trabajar con plantillas de envío - OCULTO](delivery/using/about-templates.md)
...
+ Orquestación de campañas de marketing {#orchestrating-campaigns}
   ...
   + Acerca de las campañas de marketing {#about-marketing-campaigns}
      + {hide-from-toc}[Diseño de campañas de marketing - OCULTAS](campaign/using/designing-marketing-campaigns.md)
   ...
   + Organización de campañas {#orchestrate-campaigns}
      ...
      + {hide-from-toc}[Crear y configurar plantillas - OCULTAS](campaign/using/marketing-campaign-templates.md)
      + {hide-from-toc}[Agregar envíos - OCULTOS](campaign/using/marketing-campaign-deliveries.md)
      + {hide-from-toc}[Seleccionar la audiencia - OCULTA](campaign/using/marketing-campaign-target.md)
      ...
      + {hide-from-toc}[Supervisar tus campañas: OCULTO](campaign/using/marketing-campaign-monitoring.md)
      + {hide-from-toc}[Proveedores, stock y presupuestos - OCULTOS](campaign/using/providers-stocks-and-budgets.md)
   + Optimización de la campaña {#campaign-optimization}
      + {hide-from-toc}[Acerca de las tipologías de campaña - OCULTAS](campaign-opt/using/about-campaign-typologies.md)
      + {hide-from-toc}[Reglas de presión - OCULTAS](campaign-opt/using/pressure-rules.md)
      + {hide-from-toc}[Reglas de coherencia: OCULTAS](campaign-opt/using/consistency-rules.md)
      + {hide-from-toc}[Reglas de control - OCULTAS](campaign-opt/using/control-rules.md)
      + {hide-from-toc}[Reglas de filtrado - OCULTAS](campaign-opt/using/filtering-rules.md)
      + {hide-from-toc}[Aplicar reglas - OCULTAS](campaign-opt/using/applying-rules.md)
      + {hide-from-toc}[Simulaciones de campañas - OCULTAS](campaign-opt/using/campaign-simulations.md)
+ Administración de recursos de marketing {#mrm}
   ...
   + {hide-from-toc}[Crear y administrar tareas - OCULTAS](mrm/using/creating-and-managing-tasks.md)
...
+ Marketing distribuido {#distributed-marketing}
   ...
   + {hide-from-toc}[Crear una campaña local - OCULTA](distributed/using/creating-a-local-campaign.md)
   + {hide-from-toc}[Crear una campaña de colaboración - OCULTA](distributed/using/creating-a-collaborative-campaign.md)
...
+ Integración con Adobe Experience Cloud  {#integrating-with-adobe-experience-cloud}
   ...
   + Conector ACS {#acs-connector}
      ...
      + {hide-from-toc}[Sincronizar perfiles - OCULTOS](integrations/using/synchronizing-profiles.md)
      + {hide-from-toc}[Sincronizar audiencias: OCULTO](integrations/using/synchronizing-audiences.md)
      + {hide-from-toc}[Sincronizar aplicaciones web - OCULTAS](integrations/using/synchronizing-web-applications.md)
      + {hide-from-toc}[Solucionar problemas del [!DNL ACS Connector] - OCULTO](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatización con flujos de trabajo {#automating-with-workflows}
   + Introducción a los flujos de trabajo {#introduction}
      + {hide-from-toc}[Acerca de las actividades - OCULTAS](workflow/using/about-activities.md)
      + {hide-from-toc}[Crear un flujo de trabajo - OCULTO](workflow/using/building-a-workflow.md)
      + {hide-from-toc}[Datos de destino - OCULTOS](workflow/using/targeting-data.md)
      + {hide-from-toc}[Usar datos de flujo de trabajo - OCULTO](workflow/using/how-to-use-workflow-data.md)
      + {hide-from-toc}[Prácticas recomendadas de flujo de trabajo: OCULTO](workflow/using/workflow-best-practices.md)
   + Ejecución de un flujo de trabajo {#executing-a-workflow}
      ...
      + {hide-from-toc}[Definir aprobaciones - OCULTAS](workflow/using/defining-approvals.md)
      + {hide-from-toc}[Arquitectura - OCULTA](workflow/using/architecture.md)
   + Actividades de segmentación {#targeting-activities}
      + {hide-from-toc}[Acerca de las actividades de segmentación - OCULTAS](workflow/using/about-targeting-activities.md)
      ...
      + {hide-from-toc}[Lista de lectura - OCULTA](workflow/using/read-list.md)
      + {hide-from-toc}[Unión - OCULTA](workflow/using/union.md)
      + {hide-from-toc}[Intersección - OCULTA](workflow/using/intersection.md)
      + {hide-from-toc}[Exclusión - OCULTA](workflow/using/exclusion.md)
      + {hide-from-toc}[División - OCULTA](workflow/using/split.md)
      + {hide-from-toc}[Celdas - OCULTAS](workflow/using/cells.md)
      + {hide-from-toc}[Ofertas por celda - OCULTAS](workflow/using/offers-by-cell.md)
      + {hide-from-toc}[Esquema de envío - OCULTO](workflow/using/delivery-outline.md)
      ...
      + {hide-from-toc}[Anulación de duplicación - OCULTA](workflow/using/deduplication.md)
      + {hide-from-toc}[Cambiar dimensión - OCULTA](workflow/using/change-dimension.md)
      + {hide-from-toc}[Actualización de lista - OCULTA](workflow/using/list-update.md)
      + {hide-from-toc}[Servicios de suscripción - OCULTOS](workflow/using/subscription-services.md)
      + {hide-from-toc}[Actualizar datos - OCULTOS](workflow/using/update-data.md)
      + {hide-from-toc}[Conector CRM - OCULTO](workflow/using/crm-connector.md)
      + {hide-from-toc}[Cambiar origen de datos - OCULTO](workflow/using/change-data-source.md)
   + Actividades de control de flujo {#flow-control-activities}
      + {hide-from-toc}[Acerca de las actividades de control de flujo - OCULTAS](workflow/using/about-flow-control-activities.md)
      + {hide-from-toc}[Inicio y final - OCULTO](workflow/using/start-and-end.md)
      + {hide-from-toc}[Bifurcación - OCULTA](workflow/using/fork.md)
      + {hide-from-toc}[AND-join - OCULTO](workflow/using/and-join.md)
      + {hide-from-toc}[Programador - OCULTO](workflow/using/scheduler.md)
      + {hide-from-toc}[Prueba - OCULTA](workflow/using/test.md)
      ...
      + {hide-from-toc}[Salto (puntos iniciales y finales: OCULTOS)](workflow/using/jump-start-point-and-end-point.md)
      + {hide-from-toc}[Señal externa - OCULTA](workflow/using/external-signal.md)
      + {hide-from-toc}[Aprobación - OCULTA](workflow/using/approval.md)
      + {hide-from-toc}[Alerta - OCULTA](workflow/using/alert.md)
      + {hide-from-toc}[Tarea - OCULTA](workflow/using/task.md)
   + Actividades de acción {#action-activities}
      + {hide-from-toc}[Acerca de las actividades de acción - OCULTAS](workflow/using/about-action-activities.md)
      ...
      + {hide-from-toc}[Envíos multicanal: OCULTO](workflow/using/cross-channel-deliveries.md)
      + {hide-from-toc}[Aprobación local - OCULTA](workflow/using/local-approval.md)
      + {hide-from-toc}[Carga de datos (RDBMS) - OCULTO](workflow/using/data-loading-rdbms.md)
      + {hide-from-toc}[Cargando (SOAP) - Oculto](workflow/using/loading-soap.md)
      ...
      + {hide-from-toc}[Código SQL y código JavaScript - OCULTOS](workflow/using/sql-code-and-javascript-code.md)
      + {hide-from-toc}[Administración de datos SQL - OCULTO](workflow/using/sql-data-management.md)
   ...
   + Actividades de evento {#event-activities}
      + {hide-from-toc}[Acerca de las actividades de eventos - OCULTAS](workflow/using/about-event-activities.md)
      + {hide-from-toc}[Recopilador de archivos - OCULTO](workflow/using/file-collector.md)
      + {hide-from-toc}[Transferencia de archivos - OCULTA](workflow/using/file-transfer.md)
      + {hide-from-toc}[Descarga web - OCULTA](workflow/using/web-download.md)
      + {hide-from-toc}[Correos electrónicos entrantes: OCULTOS](workflow/using/inbound-emails.md)
      + {hide-from-toc}[SMS entrante - OCULTO](workflow/using/inbound-sms.md)
   + Casos de uso {#use-cases}
      + {hide-from-toc}[Acerca de los casos de uso del flujo de trabajo - OCULTO](workflow/using/about-workflow-use-cases.md)
      + Entregas {#deliveries}
         + {hide-from-toc}[Usar la actividad de aprobación local - OCULTA](workflow/using/using-the-local-approval-activity.md)
         + {hide-from-toc}[Enviar correo electrónico de cumpleaños - OCULTO](workflow/using/sending-a-birthday-email.md)
         + {hide-from-toc}[Cargar contenido de envío - OCULTO](workflow/using/loading-delivery-content.md)
         + {hide-from-toc}[Flujo de trabajo de entrega en canales múltiples - OCULTO](workflow/using/cross-channel-delivery-workflow.md)
         + {hide-from-toc}[Enriquecimiento de correo electrónico con campos de fecha personalizados - OCULTO](workflow/using/email-enrichment-with-custom-date-fields.md)
   + Monitorización {#monitoring}
      + {hide-from-toc}[Enviar un informe a una lista - OCULTO](workflow/using/sending-a-report-to-a-list.md)
      + {hide-from-toc}[Supervisar sus flujos de trabajo - OCULTO](workflow/using/supervising-workflows.md)
   ...
   + Administración de datos {#data-management}
      ...
      + {hide-from-toc}[Crear una lista de resumen - OCULTA](workflow/using/creating-a-summary-list.md)
      + {hide-from-toc}[Enriquecer datos: OCULTO](workflow/using/enriching-data.md)
      + {hide-from-toc}[Usar agregados - OCULTOS](workflow/using/using-aggregates.md)
      + {hide-from-toc}[Usar la funcionalidad de combinación de la actividad de anulación de duplicación - OCULTO](workflow/using/deduplication-merge.md)
   ...
   + Consulta y filtro {#query-and-filter-hidden}
      + {hide-from-toc}[Consultar la tabla de destinatarios - OCULTO](workflow/using/querying-recipient-table.md)
      + {hide-from-toc}[Información de envío de consulta - OCULTA](workflow/using/querying-delivery-information.md)
      + {hide-from-toc}[Realizar computación agregada - OCULTA](workflow/using/performing-aggregate-computing.md)
      + {hide-from-toc}[Consulta que usa administración de agrupación - OCULTA](workflow/using/querying-using-grouping-management.md)
      + {hide-from-toc}[Consulta con una relación de varios a varios - OCULTA](workflow/using/querying-using-many-to-many-relationship.md)
      + {hide-from-toc}[Agregar un campo calculado de tipo de lista desglosada - OCULTO](workflow/using/adding-enumeration-type-calculated-field.md)
      + {hide-from-toc}[Crear un filtro - OCULTO](workflow/using/creating-a-filter.md)
      + {hide-from-toc}[Filtrar destinatarios duplicados - OCULTOS](workflow/using/filtering-duplicated-recipients.md)
   + Monitorización de flujos de trabajo {#monitoring-workflows}
      + {hide-from-toc}[Supervisar la ejecución del flujo de trabajo - OCULTO](workflow/using/monitoring-workflow-execution.md)
      + {hide-from-toc}[Monitorizar flujos de trabajo técnicos - OCULTOS](workflow/using/monitoring-technical-workflows.md)
      + {hide-from-toc}[Mapa de calor del flujo de trabajo - OCULTO](workflow/using/heatmap.md)
   + Gestión avanzada {#advanced-management}
      + {hide-from-toc}[Propiedades de flujo de trabajo - OCULTAS](workflow/using/workflow-properties.md)
      + {hide-from-toc}[Parámetros avanzados: OCULTO](workflow/using/advanced-parameters.md)
      + {hide-from-toc}[Plantillas y scripts de JavaScript: OCULTOS](workflow/using/javascript-scripts-and-templates.md)
      ...
      + {hide-from-toc}[Administrar permisos - OCULTOS](workflow/using/managing-rights.md)
      + {hide-from-toc}[Cambiar imágenes de actividad - OCULTAS](workflow/using/managing-activity-images.md)
      + {hide-from-toc}[Administrar zonas horarias - OCULTAS](workflow/using/managing-time-zones.md)
      + {hide-from-toc}[Flujos de trabajo técnicos - OCULTOS](workflow/using/about-technical-workflows.md)
...
+ Guía de migración  {#migrating-to-a-new-version}
   ...
   + Iniciar la migración {#migrating-to-adobe-campaign-7}
      + {hide-from-toc}[Migrar una plataforma Microsoft Windows](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
      + {hide-from-toc}[Migrar una plataforma Linux](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
...
+ Notas técnicas {#technotes}
   ...
   + Actualizaciones y compatibilidad{#technote-migration}
      ...
      + {hide-from-toc}[Nuevo servidor de envío](technotes/using/deliverability-server.md)
      ...
      + {hide-from-toc}[Fin de vida útil para la compatibilidad con TLS 1.0 y 1.1](technotes/using/eol-tls-support.md)
   + Correos electrónicos y notificaciones push{#technotes-email}
      ...
      + {hide-from-toc}[Actualizar devoluciones graves incorrectas después de una interrupción del ISP](delivery/using/update-bounces.md)
