...
+ Notas de la versión {#release-notes}
   ...
   + Versiones anteriores {#previous-releases}
      + [Versiones de 2022](rn/using/release-2022.md)
      + [Versiones de 2021](rn/using/release-2021.md)
   ...
   + [Actualizaciones de la documentación](rn/using/documentation-updates.md)
+ Introducción {#getting-started}
   ...
   + Conectores {#connectors}
      ...
      + Conector de Adobe Analytics{#analytics-connector}
         + [Introducción al conector de Adobe Analytics](platform/using/gs-aa.md)
...
+ Guía para desarrolladores {#configuring-campaign-classic}
   ...
   + Uso de esquemas{#schema-reference}
      ...
      + [Administración de claves](configuration/using/database-keys.md)
