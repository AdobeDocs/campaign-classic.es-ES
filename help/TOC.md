...
user-guide-title: Guía de Campaign Classic v7
...
+ Notas de la versión {#release-notes}
  ...
  + {hide-from-toc}[Actualizaciones de la documentación: OCULTO](rn/using/documentation-updates.md)
+ Introducción {#getting-started}
  ...
  + {hide-from-toc}[Uso de Campaign Explorer: OCULTO](platform/using/adobe-campaign-explorer.md)
  + {hide-from-toc}[Examen y personalización de listas: OCULTO](platform/using/adobe-campaign-ui-lists.md)
  + {hide-from-toc}[Listas desglosadas: OCULTO](platform/using/managing-enumerations.md)
  ...
  + {hide-from-toc}[Glosario: OCULTO](platform/using/ac-glossary.md)
  + Privacidad {#privacy}
  ...
  + Administración de perfiles {#profile-management}
    ...
    + {hide-from-toc}[Edición de un perfil: OCULTO](platform/using/editing-a-profile.md)
    + {hide-from-toc}[Añadir perfiles: OCULTO](platform/using/adding-profiles.md)
    + {hide-from-toc}[Administración de perfiles: OCULTO](platform/using/managing-profiles.md)
    + [Actualización de datos](platform/using/updating-data.md)
    + {hide-from-toc}[Importación y exportación de perfiles: OCULTO](platform/using/exporting-and-importing-profiles.md)
  ...
  + Filtrado de datos {#filtering-data}
    + {hide-from-toc}[Opciones de filtrado: OCULTO](platform/using/filtering-options.md)
    + {hide-from-toc}[Creación de filtros: OCULTO](platform/using/creating-filters.md)
    + {hide-from-toc}[Caso de uso: OCULTO](platform/using/use-case.md)
  + {hide-from-toc}[Pasos para crear una consulta: OCULTO](platform/using/steps-to-create-a-query.md)
  + {hide-from-toc}[Definición de condiciones de filtro: OCULTO](platform/using/defining-filter-conditions.md)
  + Permisos {#permissions}
    ...
    + {hide-from-toc}[Administración del acceso a las carpetas: OCULTO](platform/using/access-management-folders.md)
  + Conectores CRM {#connectors}
    + [Introducción a los conectores CRM](platform/using/crm-connectors.md)
    + {hide-from-toc}[Conexión con Microsoft Dynamics 365](platform/using/crm-ms-dynamics.md)
    + {hide-from-toc}[Conexión con Salesforce.com](platform/using/crm-sfdc.md)
    + {hide-from-toc}[Sincronización de datos con el CRM](platform/using/crm-data-sync.md)
  + {hide-from-toc}[Opciones de ayuda y asistencia: OCULTO](support.md)
+ Creación y envío de mensajes {#sending-messages}
  + [Introducción a los mensajes](delivery/using/communication-channels.md)
  + {hide-from-toc}[Configuración del envío: OCULTO](delivery/using/delivery-settings.md)
  + Inicio rápido {#key-steps-when-creating-a-delivery}
    + {hide-from-toc}[Introducción a los envíos: OCULTO](delivery/using/steps-about-delivery-creation-steps.md)
    + {hide-from-toc}[Crear e identificar un envío: OCULTO](delivery/using/steps-create-and-identify-the-delivery.md)
    + {hide-from-toc}[Definición del público: OCULTO](delivery/using/steps-defining-the-target-population.md)
    + {hide-from-toc}[Validar el envío: OCULTO](delivery/using/steps-validating-the-delivery.md)
    + {hide-from-toc}[Realizar el envío: OCULTO](delivery/using/steps-sending-the-delivery.md)
    + {hide-from-toc}[Prácticas recomendadas para envíos: OCULTO](delivery/using/delivery-best-practices.md)
  + Prácticas recomendadas para envíos {#delivery-bestpractices}
    + {hide-from-toc}[Optimizar el envío: OCULTO](delivery/using/optimize-delivery.md)
    + {hide-from-toc}[Uso de plantillas: OCULTO](delivery/using/use-templates.md)
    + {hide-from-toc}[Generar contenido personalizado: OCULTO](delivery/using/design-and-personalize.md)
    + {hide-from-toc}[Definición del público correcto: OCULTO](delivery/using/define-the-right-audience.md)
    + {hide-from-toc}[Comprobar antes de enviar: OCULTO](delivery/using/check-before-sending.md)
  + [Envío de correos electrónicos](delivery/using/about-email-channel.md)
  + Envío de correos electrónicos {#sending-emails}
    + {hide-from-toc}[Crear un envío de correo electrónico: OCULTO](delivery/using/creating-an-email-delivery.md)
    + {hide-from-toc}[Definición del contenido del correo electrónico: OCULTO](delivery/using/defining-the-email-content.md)
    + {hide-from-toc}[Definición del contenido interactivo: OCULTO](delivery/using/defining-interactive-content.md)
    + Envío de la entrega de correo electrónico {#sending-an-email}
      + {hide-from-toc}[Pasos principales para enviar un correo electrónico: OCULTO](delivery/using/sending-messages.md)
      + {hide-from-toc}[Parámetros de correo electrónico: OCULTO](delivery/using/email-parameters.md)
      + {hide-from-toc}[Enviar en móviles japoneses: OCULTO](delivery/using/sending-emails-on-japanese-mobiles.md)
    + {hide-from-toc}[Adjuntar archivos: OCULTO](delivery/using/attaching-files.md)
  + Envío de SMS {#sending-messages-on-mobiles}
    ...
    + {hide-from-toc}[Migración al conector genérico SMPP extendido](delivery/using/unsupported-connector-migration.md)
  ...
  + Envío de notificaciones push {#sending-push-notifications}
    + {hide-from-toc}[Integración del SDK de Campaign en la aplicación móvil](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
    + Configuración de la aplicación móvil{#configure-the-mobile-app}
      + {hide-from-toc}[Introducción a la configuración de aplicaciones: OCULTO](delivery/using/get-started-app-config.md)
      + {hide-from-toc}[Pasos de configuración para iOS: OCULTO](delivery/using/configuring-the-mobile-application.md)
      + {hide-from-toc}[Pasos de configuración para Android: OCULTO](delivery/using/configuring-the-mobile-application-android.md)
  ...
  + Envío de correo directo {#sending-direct-mail}
    + {hide-from-toc}[Crear un envío de correo directo: OCULTO](delivery/using/creating-a-direct-mail-delivery.md)
    + {hide-from-toc}[Definir el contenido de correo directo: OCULTO](delivery/using/defining-the-direct-mail-content.md)
    + {hide-from-toc}[Validar: OCULTO](delivery/using/validating.md)
  + Uso de plantillas de envíos {#using-delivery-templates}
    + {hide-from-toc}[Trabajo con plantillas de envío: OCULTO](delivery/using/about-templates.md)
    + {hide-from-toc}[Crear una plantilla de envíos: OCULTO](delivery/using/creating-a-delivery-template.md)
    + {hide-from-toc}[Seleccionar una asignación de público destinatario: OCULTO](delivery/using/selecting-a-target-mapping.md)
    + {hide-from-toc}[Crear un envío desde una plantilla: OCULTO](delivery/using/creating-a-delivery-from-a-template.md)
  + Personalizar los envíos {#personalizing-deliveries}
    + [Acerca de la personalización](delivery/using/about-personalization.md)
    + {hide-from-toc}[Campos de personalización: OCULTO](delivery/using/personalization-fields.md)
    + {hide-from-toc}[Bloques personalizados: OCULTO](delivery/using/personalization-blocks.md)
    + {hide-from-toc}[Contenido condicional: OCULTO](delivery/using/conditional-content.md)
    + {hide-from-toc}[Cupones personalizados: OCULTO](delivery/using/personalized-coupons.md)
    + {hide-from-toc}[Cupones personalizados: OCULTO](delivery/using/generating-personalized-pdf-documents.md)
    + {hide-from-toc}[Personalización de la lista de emoticonos](delivery/using/customizing-emoticon-list.md)
  + Uso de direcciones semilla {#using-seed-addresses}
    ...
    + [Caso de uso: seleccionar direcciones semilla según determinados criterios](delivery/using/use-case-selecting-seed-addresses-on-criteria.md)
    + [Caso de uso: configurar la sustitución de campos](delivery/using/use-case-configuring-the-field-substitution.md)
  ...
  + Monitorización de los envíos {#monitoring-deliveries}
    + [Monitorización del rendimiento de la entrega](delivery/using/about-delivery-monitoring.md)
    + [Seguimiento de mensajes](delivery/using/about-message-tracking.md)
    + [Rendimiento de la entrega y solución de problemas](delivery/using/delivery-performance-troubleshooting.md)
    + [Errores de la entrega y administración de cuarentena](delivery/using/delivery-failures-quarantine.md)
    + [Avanzado: personalizar registros de entrega](delivery/using/customize-delivery-logs.md)
...
+ Orquestación de campañas de marketing {#orchestrating-campaigns}
  + {hide-from-toc}[Acerca de la optimización de la campaña: OCULTO](campaign-opt/using/about-campaign-optimization.md)
  + Acerca de las campañas de marketing {#about-marketing-campaigns}
    + {hide-from-toc}[Diseño de campañas de marketing: OCULTO](campaign/using/designing-marketing-campaigns.md)
    + {hide-from-toc}[Acceder a campañas de marketing: OCULTO](campaign/using/accessing-marketing-campaigns.md)
  + Organización de campañas {#orchestrate-campaigns}
    + {hide-from-toc}[Introducción a las campañas de marketing: OCULTO](campaign/using/setting-up-marketing-campaigns.md)
    + {hide-from-toc}[Crear y configurar plantillas: OCULTO](campaign/using/marketing-campaign-templates.md)
    + {hide-from-toc}[Añadir envíos: OCULTO](campaign/using/marketing-campaign-deliveries.md)
    + {hide-from-toc}[Seleccionar el público: OCULTO](campaign/using/marketing-campaign-target.md)
    + {hide-from-toc}[Administrar documentos y recursos: OCULTO](campaign/using/marketing-campaign-assets.md)
    + {hide-from-toc}[Configurar y administrar aprobaciones: OCULTO](campaign/using/marketing-campaign-approval.md)
    + {hide-from-toc}[Monitorizar las campañas: OCULTO](campaign/using/marketing-campaign-monitoring.md)
    + {hide-from-toc}[Proveedores, stocks y presupuestos: OCULTO](campaign/using/providers-stocks-and-budgets.md)
  + Optimización de la campaña {#campaign-optimization}
    + {hide-from-toc}[Acerca de las tipologías de campaña: OCULTO](campaign-opt/using/about-campaign-typologies.md)
    + {hide-from-toc}[Reglas de presión: OCULTO](campaign-opt/using/pressure-rules.md)
    + {hide-from-toc}[Reglas de coherencia: OCULTO](campaign-opt/using/consistency-rules.md)
    + {hide-from-toc}[Reglas de control: OCULTO](campaign-opt/using/control-rules.md)
    + {hide-from-toc}[Opciones de filtrado: OCULTO](campaign-opt/using/filtering-rules.md)
    + {hide-from-toc}[Aplicar reglas: OCULTO](campaign-opt/using/applying-rules.md)
    + {hide-from-toc}[Simulaciones de campañas: OCULTO](campaign-opt/using/campaign-simulations.md)
+ Administración de recursos de marketing {#mrm}
  + {hide-from-toc}[Acerca de la administración de recursos de marketing: OCULTO](mrm/using/about-marketing-resource-management.md)
  + {hide-from-toc}[Creación y administración de tareas: OCULTO](mrm/using/creating-and-managing-tasks.md)
  + {hide-from-toc}[Costes de control: OCULTO](mrm/using/controlling-costs.md)
  + {hide-from-toc}[Administrar recursos de marketing: OCULTO](mrm/using/managing-marketing-resources.md)
  + {hide-from-toc}[Foros de debate: OCULTO](mrm/using/discussion-forums.md)
+ Marketing distribuido {#distributed-marketing}
  + {hide-from-toc}[Acerca del marketing distribuido: OCULTO](distributed/using/about-distributed-marketing.md)
  + {hide-from-toc}[Crear una campaña local: OCULTO](distributed/using/creating-a-local-campaign.md)
  + {hide-from-toc}[Crear una campaña colaborativa: OCULTO](distributed/using/creating-a-collaborative-campaign.md)
  + {hide-from-toc}[Publicar el paquete de campaña: OCULTO](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc}[Acceder a campañas: OCULTO](distributed/using/accessing-campaigns.md)
  + {hide-from-toc}[Seguimiento de una campaña: OCULTO](distributed/using/tracking-a-campaign.md)
...
+ Integración con Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
  ...
  + Uso compartido de públicos {#audience-sharing}
    ...
    + {hide-from-toc}[Resolución de problemas](integrations/using/troubleshooting.md)
  ...
  + Conector ACS {#acs-connector}
    + {hide-from-toc}[Introducción a: [!DNL ACS Connector]  OCULTO](integrations/using/acs-connector-principles-and-data-cycle.md)
    + {hide-from-toc}[Sincronización de perfiles: OCULTO](integrations/using/synchronizing-profiles.md)
    + {hide-from-toc}[Sincronización de públicos: OCULTO](integrations/using/synchronizing-audiences.md)
    + {hide-from-toc}[Sincronización de aplicaciones web: OCULTO](integrations/using/synchronizing-web-applications.md)
    + {hide-from-toc}[Solución de problemas de: [!DNL ACS Connector]  OCULTO](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatización con flujos de trabajo {#automating-with-workflows}
  + Introducción a los flujos de trabajo {#introduction}
    + {hide-from-toc}[Acerca de las actividades: OCULTO](workflow/using/about-activities.md)
    + {hide-from-toc}[Crear un flujo de trabajo: OCULTO](workflow/using/building-a-workflow.md)
    + {hide-from-toc}[Datos de destinatario: OCULTO](workflow/using/targeting-data.md)
    + {hide-from-toc}[Uso de datos de flujo de trabajo: OCULTO](workflow/using/how-to-use-workflow-data.md)
    + {hide-from-toc}[Prácticas recomendadas de flujos de trabajo: OCULTO](workflow/using/workflow-best-practices.md)
  + Ejecución de un flujo de trabajo {#executing-a-workflow}
    + {hide-from-toc}[Iniciar un flujo de trabajo: OCULTO](workflow/using/starting-a-workflow.md)
    + {hide-from-toc}[Ciclo de vida del flujo de trabajo: OCULTO](workflow/using/workflow-life-cycle.md)
    + {hide-from-toc}[Ciclo de vida de datos: OCULTO](workflow/using/data-life-cycle.md)
    + {hide-from-toc}[Definir aprobaciones: OCULTO](workflow/using/defining-approvals.md)
    + {hide-from-toc}[Arquitectura: OCULTO](workflow/using/architecture.md)
  + Actividades de segmentación {#targeting-activities}
    + {hide-from-toc}[Acerca de las actividades de segmentación: OCULTO](workflow/using/about-targeting-activities.md)
    + {hide-from-toc}[Consulta: OCULTO](workflow/using/query.md)
    + {hide-from-toc}[Consulta incremental: OCULTO](workflow/using/incremental-query.md)
    + {hide-from-toc}[Leer lista: OCULTO](workflow/using/read-list.md)
    + {hide-from-toc}[Unión: OCULTO](workflow/using/union.md)
    + {hide-from-toc}[Intersección: OCULTO](workflow/using/intersection.md)
    + {hide-from-toc}[Exclusión: OCULTO](workflow/using/exclusion.md)
    + {hide-from-toc}[División: OCULTO](workflow/using/split.md)
    + {hide-from-toc}[Celdas: OCULTO](workflow/using/cells.md)
    + {hide-from-toc}[Ofertas por celda: OCULTO](workflow/using/offers-by-cell.md)
    + {hide-from-toc}[Descripción del envío: OCULTO](workflow/using/delivery-outline.md)
    + {hide-from-toc}[Enriquecimiento: OCULTO](workflow/using/enrichment.md)
    + {hide-from-toc}[Edición del esquema: OCULTO](workflow/using/edit-schema.md)
    + {hide-from-toc}[Motor de oferta: OCULTO](workflow/using/offer-engine.md)
    + {hide-from-toc}[Deduplicación: OCULTO](workflow/using/deduplication.md)
    + {hide-from-toc}[Cambiar dimensión: OCULTO](workflow/using/change-dimension.md)
    + {hide-from-toc}[Actualización de la lista: OCULTO](workflow/using/list-update.md)
    + {hide-from-toc}[Servicios de suscripción: OCULTO](workflow/using/subscription-services.md)
    + {hide-from-toc}[Actualizar datos: OCULTO](workflow/using/update-data.md)
    + {hide-from-toc}[Conector CRM: OCULTO](workflow/using/crm-connector.md)
    + {hide-from-toc}[Cambiar fuente de datos: OCULTO](workflow/using/change-data-source.md)
  + Actividades de control de flujo {#flow-control-activities}
    + {hide-from-toc}[Acerca de las actividades de control de flujo: OCULTO](workflow/using/about-flow-control-activities.md)
    + {hide-from-toc}[Inicio y finalización: OCULTO](workflow/using/start-and-end.md)
    + {hide-from-toc}[Bifurcación: OCULTO](workflow/using/fork.md)
    + {hide-from-toc}[Combinación-Y: OCULTO](workflow/using/and-join.md)
    + {hide-from-toc}[Planificador: OCULTO](workflow/using/scheduler.md)
    + {hide-from-toc}[Prueba: OCULTO](workflow/using/test.md)
    + {hide-from-toc}[Esperar: OCULTO](workflow/using/wait.md)
    + {hide-from-toc}[Restricción de tiempo: OCULTO](workflow/using/time-constraint.md)
    + {hide-from-toc}[Subflujo de trabajo: OCULTO](workflow/using/sub-workflow.md)
    + {hide-from-toc}[Saltar (punto inicial y punto final: OCULTO)](workflow/using/jump-start-point-and-end-point.md)
    + {hide-from-toc}[Señal externa: OCULTO](workflow/using/external-signal.md)
    + {hide-from-toc}[Aprobación: OCULTO](workflow/using/approval.md)
    + {hide-from-toc}[Alerta: OCULTO](workflow/using/alert.md)
    + {hide-from-toc}[Tarea: OCULTO](workflow/using/task.md)
  + Actividades de acción {#action-activities}
    + {hide-from-toc}[Acerca de las actividades de acción: OCULTO](workflow/using/about-action-activities.md)
    + {hide-from-toc}[Envío: OCULTO](workflow/using/delivery.md)
    + {hide-from-toc}[Control de envío: OCULTO](workflow/using/delivery-control.md)
    + {hide-from-toc}[Envío continuo: OCULTO](workflow/using/continuous-delivery.md)
    + {hide-from-toc}[Envío recurrente: OCULTO](workflow/using/recurring-delivery.md)
    + {hide-from-toc}[Envíos en canales múltiples: OCULTO](workflow/using/cross-channel-deliveries.md)
    + {hide-from-toc}[Aprobación local: OCULTO](workflow/using/local-approval.md)
    + {hide-from-toc}[Carga de datos (RDBMS): OCULTO](workflow/using/data-loading-rdbms.md)
    + {hide-from-toc}[Carga (SOAP): OCULTO](workflow/using/loading-soap.md)
    + {hide-from-toc}[Carga de datos (archivo): OCULTO](workflow/using/data-loading-file.md)
    + {hide-from-toc}[Administración de contenido: OCULTO](workflow/using/content-management.md)
    + {hide-from-toc}[Extracción de datos (archivo): OCULTO](workflow/using/extraction-file.md)
    + {hide-from-toc}[Código SQL y código JavaScript: OCULTO](workflow/using/sql-code-and-javascript-code.md)
    + {hide-from-toc}[Gestión de datos SQL: OCULTO](workflow/using/sql-data-management.md)
    + {hide-from-toc}[Módulo Nlserver: OCULTO](workflow/using/nlserver-module.md)
    + {hide-from-toc}[Actualizar agregado: OCULTO](workflow/using/update-aggregate.md)
  + Actividades de evento {#event-activities}
    + {hide-from-toc}[Acerca de las actividades de evento: OCULTO](workflow/using/about-event-activities.md)
    + {hide-from-toc}[Recolector de ficheros: OCULTO](workflow/using/file-collector.md)
    + {hide-from-toc}[Transferencia de archivos: OCULTO](workflow/using/file-transfer.md)
    + {hide-from-toc}[Descarga de web: OCULTO](workflow/using/web-download.md)
    + {hide-from-toc}[Correos electrónicos de entrada: OCULTO](workflow/using/inbound-emails.md)
    + {hide-from-toc}[Código SMS de entrada: OCULTO](workflow/using/inbound-sms.md)
  + Casos de uso {#use-cases}
    + {hide-from-toc}[Acerca de los casos de uso de flujos de trabajo: OCULTO](workflow/using/about-workflow-use-cases.md)
    + Envíos {#deliveries}
      + {hide-from-toc}[Uso de la actividad de aprobación local: OCULTO](workflow/using/using-the-local-approval-activity.md)
      + {hide-from-toc}[Enviar un correo electrónico de cumpleaños: OCULTO](workflow/using/sending-a-birthday-email.md)
      + {hide-from-toc}[Carga de contenido de envíos: OCULTO](workflow/using/loading-delivery-content.md)
      + {hide-from-toc}[Flujo de trabajo de envío en canales múltiples: OCULTO](workflow/using/cross-channel-delivery-workflow.md)
      + {hide-from-toc}[Enriquecimiento de correo electrónico con campos de datos personalizados: OCULTO](workflow/using/email-enrichment-with-custom-date-fields.md)
  + Monitorización {#monitoring}
    + {hide-from-toc}[Enviar un informe a una lista: OCULTO](workflow/using/sending-a-report-to-a-list.md)
    + {hide-from-toc}[Supervisar los flujos de trabajo: OCULTO](workflow/using/supervising-workflows.md)
    + {hide-from-toc}[Enviar alertas personalizadas a operadores: OCULTO](workflow/using/sending-personalized-alerts-to-operators.md)
  + Administración de datos {#data-management}
    + {hide-from-toc}[Coordinar actualizaciones de datos: OCULTO](workflow/using/coordinating-data-updates.md)
    + {hide-from-toc}[Crear una lista de resumen: OCULTO](workflow/using/creating-a-summary-list.md)
    + {hide-from-toc}[Enriquecer datos: OCULTO](workflow/using/enriching-data.md)
    + {hide-from-toc}[Uso de acumulados: OCULTO](workflow/using/using-aggregates.md)
    + {hide-from-toc}[Uso de la funcionalidad de combinación de la actividad de deduplicación: OCULTO](workflow/using/deduplication-merge.md)
    + {hide-from-toc}[Configurar un flujo de trabajo de importación recurrente: OCULTO](workflow/using/recurring-import-workflow.md)
  + Diseño de consultas {#designing-queries}
    + {hide-from-toc}[Actualización de lista trimestral con una consulta incremental: OCULTO](workflow/using/quarterly-list-update.md)
  + Consulta y filtro {#query-and-filter-hidden}
    + {hide-from-toc}[Consulta de la tabla de destinatarios: OCULTO](workflow/using/querying-recipient-table.md)
    + {hide-from-toc}[Consulta de la información de envío: OCULTO](workflow/using/querying-delivery-information.md)
    + {hide-from-toc}[Realizar cálculo de acumulados: OCULTO](workflow/using/performing-aggregate-computing.md)
    + {hide-from-toc}[Consulta mediante la administración de agrupaciones: OCULTO](workflow/using/querying-using-grouping-management.md)
    + {hide-from-toc}[Consulta con una relación de varios a varios: OCULTO](workflow/using/querying-using-many-to-many-relationship.md)
    + {hide-from-toc}[Añadir un campo calculado de tipo lista desglosada: OCULTO](workflow/using/adding-enumeration-type-calculated-field.md)
    + {hide-from-toc}[Crear un filtro: OCULTO](workflow/using/creating-a-filter.md)
    + {hide-from-toc}[Filtro de destinatarios duplicados: OCULTO](workflow/using/filtering-duplicated-recipients.md)
  + Monitorización de flujos de trabajo {#monitoring-workflows}
    + {hide-from-toc}[Monitorizar la ejecución del flujo de trabajo: OCULTO](workflow/using/monitoring-workflow-execution.md)
    + {hide-from-toc}[Monitorizar flujos de trabajo técnicos: OCULTO](workflow/using/monitoring-technical-workflows.md)
    + {hide-from-toc}[Mapa de calor del flujo de trabajo: OCULTO](workflow/using/heatmap.md)
  + Gestión avanzada {#advanced-management}
    + {hide-from-toc}[Propiedades del flujo de trabajo: OCULTO](workflow/using/workflow-properties.md)
    + {hide-from-toc}[Parámetros avanzados: OCULTO](workflow/using/advanced-parameters.md)
    + {hide-from-toc}[Scripts y plantillas de JavaScript: OCULTO](workflow/using/javascript-scripts-and-templates.md)
    + {hide-from-toc}[Ejemplos de código JavaScript en flujos de trabajo: OCULTO](workflow/using/javascript-in-workflows.md)
    + {hide-from-toc}[Acceder a una base de datos externa: OCULTO](workflow/using/accessing-an-external-database-fda.md)
    + {hide-from-toc}[Administración de permisos: OCULTO](workflow/using/managing-rights.md)
    + {hide-from-toc}[Cambiar imágenes de actividad: OCULTO](workflow/using/managing-activity-images.md)
    + {hide-from-toc}[Administrar zonas horarias: OCULTO](workflow/using/managing-time-zones.md)
    + {hide-from-toc}[Flujos de trabajo técnicos: OCULTO](workflow/using/about-technical-workflows.md)
...
+ Guía de instalación y configuración {#installing-campaign-classic}
  ...
  + Configuración de Campaign {#additional-configurations}
    ...
    + {hide-from-toc}[Uso de servidores MX con Campaign](installation/using/using-mx-servers.md)
  ...
  + Apéndices {#appendices}
    ...
    + {hide-from-toc}[Desinstalación de Campaign](installation/using/uninstalling-campaign.md)
...
+ Guía de monitorización {#monitoring-campaign-classic}
  ...
  + Actualización de Adobe Campaign {#updating-adobe-campaign}
    ...
    + {hide-from-toc}[Procedimientos de migración](production/using/migration-procedures.md)
...
+ Guía de migración {#migrating-to-a-new-version}
  + {hide-from-toc}[Migración a la versión 7 de Adobe Campaign](migration/using/about-migration.md)
  ...
  + Iniciar la migración {#migrating-to-adobe-campaign-7}
    + {hide-from-toc}[Migración de una plataforma Microsoft Windows](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
    + {hide-from-toc}[Migración de una plataforma Linux](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
  + {hide-from-toc}[Procedimiento de reversión](migration/using/about-rollback.md)
+ Notas técnicas {#technotes}
  ...
  + Actualizaciones y compatibilidad{#technote-migration}
    ...
    + {hide-from-toc}[Nuevo servidor de capacidad de entrega](technotes/using/deliverability-server.md)
    + {hide-from-toc}[Actualización de seguridad de Apache](technotes/using/acc-apache-upgrade.md)
  ...
  + Correos electrónicos y notificaciones push{#technotes-email}
    ...
    + {hide-from-toc}[Actualización de estado de devoluciones graves incorrectas después de una interrupción ISP](delivery/using/update-bounces.md)
    + [Actualización de certificado de iOS](technotes/using/ios-certificate-update.md)
    + {hide-from-toc}[Actualización de direcciones URL rastreadas](technotes/using/tracked-urls.md)
