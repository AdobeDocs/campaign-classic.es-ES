...
Para enviar la encuesta, puede enviar un mensaje a la población objetivo que contenga un enlace de acceso o colocar la URL de acceso a la encuesta en una página web, por ejemplo.
...
>[!CAUTION]
>
>La dirección URL pública incluye el nombre interno de la encuesta. Cuando se modifica el nombre interno, la dirección URL se actualiza automáticamente: todos los enlaces a la encuesta deben actualizarse.
>
>Si los envíos que contenían el enlace al formulario ya se han enviado, este enlace deja de funcionar.
