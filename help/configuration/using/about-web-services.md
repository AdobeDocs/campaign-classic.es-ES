...
>Hay disponible una lista de todas las API, con su descripción completa, en [esta documentación dedicada]&#x200B;(https://experienceleague.adobe.com/en/tools/campaign-api
