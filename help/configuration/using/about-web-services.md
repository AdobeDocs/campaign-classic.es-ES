...
>En [esta documentación](https://docs.adobe.com/content/help/en/campaign-classic/technicalresources/api/index.html

)específica encontrará una lista de todas las API, incluida su descripción completa.
