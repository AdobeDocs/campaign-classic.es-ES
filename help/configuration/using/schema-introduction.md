...
Al editar un esquema, está disponible un sistema de aprobación basado en el esquema de origen (xtk:srcSchema). Algunos errores también se pueden detectar al actualizar la base de datos con el asistente &quot;Database structure update...&quot;.
