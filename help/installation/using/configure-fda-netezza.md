...
1. Configurar la [cuenta externa](#netezza-external) Netezza en Campaña
...
La cuenta externa Netezza le permite conectar la instancia de Campaña a la base de datos externa de Netezza.
