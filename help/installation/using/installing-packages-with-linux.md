...
Con Campaign v7.4.1, como cliente On-Premise que utiliza RHEL 9, si desea utilizar la autenticación de DKIM (Domain Keys Identified Mail), debe actualizar la configuración del sistema.
