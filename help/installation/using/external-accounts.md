...
* [Cuenta externa del almacenamiento de blob de Azure ](#azure-blob-external-account)
...
## Cuenta externa del almacenamiento del blob de Azure (#azure-blob-external-account)
