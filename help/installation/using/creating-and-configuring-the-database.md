...
1. Crear o reciclar una base de datos: seleccione esta opción si desea crear una base de datos nueva o volver a utilizar una existente. Consulte [Caso 1: crear/reciclar una base de datos](#case-1--creating-recycling-a-database).
1. Using an existing database: elija esta opción si el administrador ya ha creado una base de datos vacía y desea utilizarla, o para ampliar la estructura de una base de datos existente. Consulte [Caso 2: usar una base de datos existente](#case-2--using-an-existing-database).
...
Las bases de datos compatibles se enumeran en Campaign [Compatibility matrix](../../rn/using/compatibility-matrix.md).
...
* Para un motor **PostgreSQL**, debe especificar el nombre DNS (o la dirección IP) definido en el servidor de aplicaciones para tener acceso al servidor de base de datos.
...
En la ventana **[!UICONTROL Server access]**, defina el acceso al servidor de base de datos.

![](assets/s_ncs_install_db_oracle_creation02.png)

Para ello, escriba el nombre y la contraseña de una **cuenta del sistema de administración** que tenga permiso para obtener acceso a las bases de datos, por ejemplo:

* **system** para una base de datos de Oracle,
...
* Indique si la base de datos debe estar en Unicode o no.
  ...
  La opción **[!UICONTROL Unicode database]** le permite almacenar todos los tipos de caracteres en Unicode independientemente del idioma.

  >[!NOTE]
  >
  >Con una base de datos de Oracle, la opción **[!UICONTROL Unicode storage]** le permite utilizar los campos de tipo **NCLOB** y **NVARCHAR**.
  > 
...
La ventana **[!UICONTROL Creation steps]** le permite mostrar y editar el script SQL utilizado para crear las tablas.
...
* Para un motor **Microsoft SQL Server**, debe definir:
   ...
   1. el método de seguridad usado para obtener acceso a Microsoft SQL Server: **[!UICONTROL SQL Server authentication]** o **[!UICONTROL Windows NT authentication]**.

      ![](assets/s_ncs_install_db_mssql_exists_01.png)

### Paso 2: Configuración de conexión a base de datos {#step-2---database-connection-settings}

En la ventana **[!UICONTROL Database]**, defina la configuración de conexión a la base de datos.
