...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> IMSOrgId<br /> </td> 
   <td> ID de organización: identificador de organización único dentro de Adobe Experience Cloud, utilizado en particular para el servicio VisitorID y el SSO de IMS. <br /> </td> 
   <td> Cadena<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
