...
1. Integrar con un servidor web (opcional, según los componentes implementados), consulte [Configuración del servidor web de IIS](../../installation/using/integration-into-a-web-server-for-windows.md#configuring-the-iis-web-server).
