...
1. Abra **[!UICONTROL Generic query editor]** y seleccione el esquema **[!UICONTROL Recipient tracking logs]**.

   ![](assets/query_editor_tracklog_05.png)

1. En la ventana **[!UICONTROL Data to extract]**, se desea crear un acumulado para recopilar información. Para ello, añada la clave principal (ubicada encima del elemento **[!UICONTROL Recipient tracking logs]** principal): El recuento de registros de seguimiento se realiza en este campo de clave **[!UICONTROL Primary key]**. La expresión editada es **[!UICONTROL x=count(primary key)]**. Vincula la suma de diversos registros de seguimiento a una sola dirección de correo electrónico.

   Para ello:

   * A la derecha del campo **[!UICONTROL Output columns]**, haga clic en el icono **[!UICONTROL Add]**. En la ventana **[!UICONTROL Formula type]**, seleccione la opción **[!UICONTROL Edit the formula using an expression]** y haga clic en **[!UICONTROL Next]**. En la ventana **[!UICONTROL Field to select]**, haga clic en **[!UICONTROL Advanced selection]**.
   ...
   * En la ventana **[!UICONTROL Formula type]**, ejecute un proceso en la función de acumulado. Este proceso es un recuento de clave principal.
      ...
      En la sección **[!UICONTROL Aggregate]**, seleccione **[!UICONTROL Process on an aggregate function]** y haga clic en **[!UICONTROL Count]**.
...
1. Configure la ordenación de columnas para que se muestren primero los destinatarios más activos (con la mayoría de registros de seguimiento). En la columna **[!UICONTROL Descending sort]**, marque **[!UICONTROL Yes]**.
...
1. A continuación, se debe filtrar los registros de interés, es decir, aquellos que tengan menos de 2 semanas y que impliquen envíos relacionados con ventas.
   ...
   * Configure el filtrado de datos. Para ello, seleccione **[!UICONTROL Filter conditions]** y, a continuación, haga clic en **[!UICONTROL Next]**.
   ...
   * Recupere los registros de seguimiento durante un periodo determinado para una entrega específica. Se necesitan tres condiciones de filtrado: dos condiciones de fecha para establecer el periodo de búsqueda entre 2 semanas antes de la fecha actual y el día antes de la fecha actual; y otra condición para restringir la búsqueda a una entrega específica.
      ...
      Seleccione el operador **[!UICONTROL greater than]**. En la columna **[!UICONTROL Value]**, haga clic en **[!UICONTROL Edit expression]** y, en la ventana **[!UICONTROL Formula type]**, seleccione **[!UICONTROL Process on dates]**. Por último, en **[!UICONTROL Current date minus n days]**, introduzca “15”.

      Haga clic en **[!UICONTROL Finish]**.

      ![](assets/query_editor_nveau_24.png)

   * Para seleccionar la fecha de finalización de la búsqueda del registro de seguimiento, cree una segunda condición haciendo clic en **[!UICONTROL Add]**. En la columna **[!UICONTROL Expression]**, vuelva a elegir **[!UICONTROL Date (@logDate)]**.
...
1. Configure el **[!UICONTROL Operator]** de la expresión **[!UICONTROL Tracking logs]** en **[!UICONTROL Do not exist such as]**.

   ![](assets/query_open_1.png)

1. Agregue otra expresión. En la categoría **[!UICONTROL URL]**, seleccione **[!UICONTROL Type]**.
...
Si, por el contrario, se desea filtrar los destinatarios que hayan abierto al menos un correo electrónico, la consulta debe ser la siguiente: Tenga en cuenta que, en este caso, **[!UICONTROL Filtering dimension]** se debe configurar en **[!UICONTROL Tracking logs (Recipients)]**.
...
1. En la ventana **[!UICONTROL Targeting and filtering dimension]**, haga clic en **[!UICONTROL Delivery recipients]**.
...
* **[!UICONTROL Todos los destinatarios]**
* **[!UICONTROL Destinatarios de mensajes enviados correctamente,]**
* **[!UICONTROL Destinatarios que abrieron o hicieron clic (correo electrónico),]**
* **[!UICONTROL Destinatarios que hicieron clic (correo electrónico),]**
* **[!UICONTROL Destinatarios de un mensaje con error,]**
* **[!UICONTROL Destinatarios que no abrieron ni hicieron clic (correo electrónico),]**
* **[!UICONTROL Destinatarios que no hicieron clic (correo electrónico).]**
