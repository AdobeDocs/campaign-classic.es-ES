...
1. Añada una actividad **[!UICONTROL Delivery]** y conéctela a la transición saliente de la actividad **[!UICONTROL File transfer]**. Configúrela como se indica a continuación:
   ...
   * Action to perform: Seleccione **[!UICONTROL Save]** para guardar la entrega y poder acceder a él desde **[!UICONTROL Campaign management]** > **[!UICONTROL Deliveries]** una vez que se ejecute el flujo de trabajo.
