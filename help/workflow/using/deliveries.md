...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Agregados</span> de informes <br /> </td> 
   <td> <span class="uicontrol">reportingAggregates</span><br /> </td> 
   <td> Este flujo de trabajo actualiza los agregados que se utilizan en los informes. Se activa cada día a la 2 de la mañana
								de forma predeterminada.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <span class="uicontrol">Limpieza</span> de bases de datos <br /> </td> 
  ...
  <tr> 
   ...
   <td> Este flujo de trabajo analiza los envíos guardados en el calendario provisional
								(crea registros provisionales). Se activa cada día a la 1 de la mañana
								de forma predeterminada.<br /> </td> 
  </tr> 
  <tr> 
