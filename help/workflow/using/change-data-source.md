...
**[!UICONTROL Working table]** permite que el flujo de trabajo de Adobe Campaign Classic administre datos y los comparta con las actividades de flujo de trabajo.
De manera predeterminada, **[!UICONTROL Working table]** se crea en la misma base de datos que el origen de los datos que consultamos.
...
Para cambiar esto, puede agregar la actividad **[!UICONTROL Change Data Source]** para elegir un origen de datos diferente para su **[!UICONTROL Working table]**.
