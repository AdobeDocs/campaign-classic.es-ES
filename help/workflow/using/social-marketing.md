...
Los flujos de trabajo detallados a continuación se instalan con el módulo **Social
				Marketing** de forma predeterminada. Para obtener más información sobre este módulo, consulte esta [sección](../../social/using/starting-workflows.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Cálculo de estadísticas</span> de Facebook <br /> </td> 
