...
| **Actualización para la entrega** (deliverabilityUpdate) | Entrega | Este flujo de trabajo se ejecuta todas las noches y gestiona las reglas de calificación de los correos electrónicos rechazados, así como la lista de dominios y los MX. Esto requiere que el puerto HTTPS se abra en la plataforma. |