...
* **Change dimension**: permite cambiar la dimensión de segmentación durante el ciclo de la construcción del flujo de trabajo. Consulte la sección [Cambiar dimensión](../../workflow/using/change-dimension.md).
