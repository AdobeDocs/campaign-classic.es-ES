...
1. En **[!UICONTROL Data to extract]**, defina un recuento para la clave principal (como se muestra en el ejemplo anterior). Añada el campo **[!UICONTROL Gender]** en la columna de salida. En la columna **[!UICONTROL Gender]**, marque la opción **[!UICONTROL Group]**. De este modo, los destinatarios se agrupan por género.
