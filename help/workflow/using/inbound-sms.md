...
1. **[!UICONTROL SMS routing]**: Seleccione la cuenta externa que se utilizará para la recuperación de SMS. External accounts are configured via the **[!UICONTROL Administration > Platform > External accounts]** node of the tree.
1. **[!UICONTROL Script]**
...
Las fichas **[!UICONTROL Script]**, **[!UICONTROL Schedule]** y **[!UICONTROL Expiry]** se detallan en [Correos electrónicos](../../workflow/using/inbound-emails.md)entrantes.
