...
seo-title: Plantillas y secuencias de comandos de JavaScript
...
Por consiguiente, para llamar a una variable en un filtro **instance.vars.xxx = &quot;yyy&quot;**, escriba **$(instancia/vars/xxx)**.
