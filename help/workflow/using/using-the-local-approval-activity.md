...
description: Aprenda a utilizar la actividad de aprobación local
audience: workflow
...
## Paso 1: Creación de una plantilla de distribución de datos {#step-1--creating-the-data-distribution-template-}
