...
<target xml:lang="en-XX">Para obtener más información sobre todas las funciones adicionales de JavaScript y los métodos SOAP del servidor aplicativo accesible mediante JavaScript de flujo de trabajo, consulte la <ph id="1" ctype="x-LINK">[</ph>Documentación de JSAPI<ph id="2" ctype="x-LINK">[#$tu8]</ph>.</target>
</trans-unit>
