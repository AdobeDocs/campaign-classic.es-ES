---
title: Flujo de trabajo de envío por canales cruzados
seo-title: Flujo de trabajo de envío por canales cruzados
description: Flujo de trabajo de envío por canales cruzados
...
# Flujo de trabajo de envío por canales cruzados{#cross-channel-delivery-workflow}
...
1. Using a **[!UICONTROL Split]** activity to:
   ...
   * Enviar un SMS a los destinatarios que abrieron el correo electrónico pero que no hicieron clic en el enlace de la oferta.
   * Agregar a la base de datos los destinatarios que abrieron el correo electrónico e hicieron clic en el enlace.
...
1. Defina los destinatarios que recibirán los envíos. Por ejemplo, seleccione miembros “Gold” como el entorno objetivo.
...
1. Diseñe el mensaje e inserte un enlace que incluya una oferta en el contenido.
...
1. In the filter settings, select **[!UICONTROL Recipients who have not opened or clicked (email)]** from the **[!UICONTROL Behavior]** drop-down list and select the email including the offer you want to send from the delivery list. Haga clic **[!UICONTROL Finish]**.

   ![](assets/wkf_cross-channel_10.png)

1. Proceda de forma similar para el segundo subconjunto y selecciónelo **[!UICONTROL Recipients who have not clicked (email)]** en la lista **[!UICONTROL Behavior]** desplegable.
...
1. Seleccione **[!UICONTROL Recipient tracking log]** en la lista **[!UICONTROL Filtering dimension]** desplegable, resalte **[!UICONTROL Filtering conditions]** en la **[!UICONTROL List of restriction filters]** lista y haga clic en **[!UICONTROL Next]**.
...
1. Haga doble clic en la **[!UICONTROL List update]** actividad y seleccione la **[!UICONTROL Generate an outbound transition]** opción.
