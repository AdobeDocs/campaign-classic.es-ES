...
1. Según sus necesidades, puede crear una o varias plantillas de tipo **[!UICONTROL Delivery]**, tal como se describe en [Creación de un modelo de hipótesis](../../campaign/using/hypothesis-templates.md#creating-a-hypothesis-model)
...
1. Cree uno o varios modelos de tipo de **[!UICONTROL Offer]** como se describe en [Creación de un modelo de hipótesis](../../campaign/using/hypothesis-templates.md#creating-a-hypothesis-model).
