...
1. Defina el método para calcular el número más alto de mensajes.
   ...
   Para definir un umbral de variable, en el campo **[!UICONTROL Type of threshold]** seleccione el valor **[!UICONTROL Depends on the recipient]** y utilice el icono de la derecha para abrir el editor de expresiones.
...
o
>
>* Opción de introducir **7d** en el campo **[!UICONTROL Period considered]** Y marcar **[!UICONTROL Take the deliveries into account in the provisional calendar]**\
...
1. Edite la pestaña **[!UICONTROL Pressure]**: en la sección **[!UICONTROL Maximum number of messages]** se busca crear una fórmula para calcular el umbral en función de cada destinatario. En el campo **[!UICONTROL Threshold type]** seleccione el valor **[!UICONTROL Depends on the recipient]** y haga clic en **[!UICONTROL Edit expression]** a la derecha del campo **[!UICONTROL Formula]**.
...
1. En la lista de funciones, haga doble clic en la función **Iif** en el nodo **[!UICONTROL Others]**.
   ...
   A continuación, en la sección **[!UICONTROL Available fields]**, seleccione **Status** de los destinatarios.
...
1. Seleccione la opción **[!UICONTROL Take the deliveries into account in the provisional calendar]** para incluir las entregas programadas.
...
1. En **[!UICONTROL Delivery properties]** vaya a la pestaña **[!UICONTROL Approvals]** y deshabilite todas las aprobaciones.
...
1. En la entrega, haga clic en **[!UICONTROL Scheduling]** y seleccione **[!UICONTROL Schedule delivery (automatic execution when the scheduled date is reached)]**. En este ejemplo, seleccione la opción **[!UICONTROL Use a calculation formula]**.
