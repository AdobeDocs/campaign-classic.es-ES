...
Al importar una audiencia o compartirla mediante una audiencia de Experience Cloud, puede que falten algunos datos. Solo se transfieren los registros cuya ID (“ID de visitante” o “ID declarada”) se haya podido reconciliar con la dimensión del perfil. Las ID de los segmentos no reconocidos por Adobe Campaign no se importan.
