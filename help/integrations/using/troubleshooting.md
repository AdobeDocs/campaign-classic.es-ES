...
* **Cuentas externas**
   ...
   In **[!UICONTROL Administration > Platform > External accounts]**, make sure that the following external SFTP accounts are correctly configured. Su consultor debe configurar en Adobe Experience 
         Cloud los servidores SFTP mencionados.
