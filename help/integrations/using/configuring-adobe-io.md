...
Para actualizar la etiqueta [!DNL pipelined], debe actualizar el tipo de autenticación en el proyecto de Developer Console en el archivo de configuración **config-&lt; inombre_instancia >.xml** como se indica a continuación:
