...
1. Puede cambiar los ejes de la dimensión, eliminarlos, añadir nuevas medidas, etc. Las operaciones posibles se detallan en [esta página](../../reporting/using/using-cubes-to-explore-data.md).
