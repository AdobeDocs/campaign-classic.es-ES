...
En el siguiente ejemploe, todos los dominios de correo electrónico que comienzan por **yahoo** (yahoo.fr, yahoo.com, yahoo.be, etc.) o por **ymail** (ymail.com, ymail.eu, etc.) se agruparán bajo la etiqueta **YAHOO!**, así como direcciones con el dominio **rocketmail.com**.
...
* qué medidas se desean mostrar: porcentaje, total, número de decimales, etc. (consulte [Modificación del tipo de medida mostrada](#changing-the-type-of-measure-displayed)).
