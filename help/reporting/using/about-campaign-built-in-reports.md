...
seo-title: Acerca de los informes integrados de Campaign
...
>[!NOTE]
>
>También puede aprender a agregar sus propios informes a la **[!UICONTROL Reports]** ficha. Para obtener más información, consulte esta [página](../../reporting/using/configuring-access-to-the-report.md#defining-the-filtering-options).
...
1. Seleccione la **[!UICONTROL Reports]** ficha de la interfaz de Adobe Campaign.
...
Se puede acceder a los informes que son específicos de una campaña o un envío a través de sus respectivos paneles.
