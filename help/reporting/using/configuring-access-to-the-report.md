...
El acceso al informe se puede limitar a un contexto específico o a un espacio de oferta, por ejemplo un envío, un destinatario, una selección de destinatarios, etc. Este acceso se configura en la **[!UICONTROL Selection type]** sección de la **[!UICONTROL Display]** ficha.
...
* **[!UICONTROL Global]** :: se puede acceder al informe a través de la lista de informes disponibles en el universo de los informes.
...
Se puede hacer que un informe sea accesible a través de un nodo específico del árbol, como una lista, un destinatario, un envío, etc. Para hacerlo, simplemente genere un vínculo al informe correspondiente y especifique la entidad donde desea que esté disponible.
...
Estas dos opciones se seleccionan según la configuración de visualización del informe. If the display setting is **[!UICONTROL Global]**, you need to select the **[!UICONTROL Global]** preview option. Si la configuración de visualización es **[!UICONTROL Single selection]** o **[!UICONTROL Multiple selection]**, se debe seleccionar la opción de **[!UICONTROL Selection]** vista previa.

Para obtener más información sobre esto, consulte [Informe de contexto](#report-display-context)de visualización.
...
Publishing the report is mandatory in order to share them with other operators and display them in the list of available reports (also refer to [Report display context](#report-display-context)). Esta operación debe llevarse a cabo cada vez que se modifica el informe.
